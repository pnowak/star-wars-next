...
export const FETCH_FILMS_SUCCEEDED = 'FETCH_FILMS_SUCCEEDED';
...
export const FETCH_PLANETS_SUCCEEDED = 'FETCH_PLANETS_SUCCEEDED';
export const FETCH_PLANETS_FAILED = 'FETCH_PLANETS_FAILED';

export const FETCH_SPECIES_REQUEST = 'FETCH_SPECIES_REQUEST';
export const FETCH_SPECIES_STARTED = 'FETCH_SPECIES_STARTED';
export const FETCH_SPECIES_SUCCEEDED = 'FETCH_SPECIES_SUCCEEDED';
...
export const FETCH_STARSHIPS_SUCCEEDED = 'FETCH_STARSHIPS_SUCCEEDED';
...
export const FETCH_VEHICLES_SUCCEEDED = 'FETCH_VEHICLES_SUCCEEDED';
